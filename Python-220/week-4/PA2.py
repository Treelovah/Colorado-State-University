...
if __name__ == "__main__":
    ...
    tt1 = []
    if(f1 == "implies"):
        tt1 = eval_tt_f2(PA1.implies)
    if(f1 == "iff"):
        tt1 = eval_tt_f2(PA1.iff)
    if(f1 == "npIMPnq"):
        tt1 = eval_tt_f2(PA1.npIMPnq)
    if(f1 == "nqIMPnp"):
        tt1 = eval_tt_f2(PA1.nqIMPnp)
    if(f1 == "nand"):
        tt1 = eval_tt_f2(PA1.nand)
    if(f1 == "nor"):
        tt1 = eval_tt_f2(PA1.nor)
    if(f1 == "npANDnq"):
        tt1 = eval_tt_f2(PA1.npANDnq)
    if(f1 == "npORnq"):
        tt1 = eval_tt_f2(PA1.npORnq)
    print(tt1)
    ...
    if(argc > 2):
        ...
        tt2 = []
        if(f2 == "implies"):
            tt2 = eval_tt_f2(PA1.implies)
        if(f2 == "iff"):
            tt2 = eval_tt_f2(PA1.iff)
        if(f2 == "npIMPnq"):
            tt2 = eval_tt_f2(PA1.npIMPnq)
        if(f2 == "nqIMPnp"):
            tt2 = eval_tt_f2(PA1.nqIMPnp)
        if(f2 == "nand"):
            tt2 = eval_tt_f2(PA1.nand)
        if(f2 == "nor"):
            tt2 = eval_tt_f2(PA1.nor)
        if(f2 == "npANDnq"):
            tt2 = eval_tt_f2(PA1.npANDnq)
        if(f2 == "npORnq"):
            tt2 = eval_tt_f2(PA1.npORnq)
        print(tt2)
