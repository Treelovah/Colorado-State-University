...
public class MovieAnalysis {
    ...
    public Movie search(String title){
        for (Movie m : movies) if (m.getName().equals(title)) return m;
        return null;
    }
    ...
    public Movie getHighestRated(){
        ...
        Movie higestRatedMovie = null;
        for (Movie m : movies) if (m.getAverageRating() > max) 
        {
            max = m.getAverageRating();
            higestRatedMovie = m;
        }
        return higestRatedMovie;
    }
    ...
    public Movie getLowestRated(){
        ...
        for (Movie m : movies) if (m.getAverageRating() < low)
        {
